...
public class ForumApiClient {
    ...
    public List<ForumDto> getAllForumPosts() throws Exception {
        ...
        ApiResponse<List<ForumDto>> responseObj = objectMapper.readValue(
                response.body(), 
                new TypeReference<ApiResponse<List<ForumDto>>>() {});
    ...
    public ForumDto createForumPost(ForumDto forumPost) throws Exception {
        ...
        ApiResponse<ForumDto> responseObj = objectMapper.readValue(
                response.body(), 
                new TypeReference<ApiResponse<ForumDto>>() {});
        return responseObj.getMessage();
    }
